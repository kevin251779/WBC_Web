        ...
        <td width="89" height="50" valign="middle" >
            <div style="margin-top:3%;text-align:right;margin-right:6%">
                  <select onchange="window.location.href=this.value;" style="font-size:1.2em;">
                    ...
                    <option  value="competitiondateC.php"href="competitiondateC.php">C組 大通銀行球場</option>
                    <option selected value="competitiondateD.php" href="competitiondateD.php">D組 馬林魚球場</option>
                  </select>   
            </div>
        </td>
                          ...
                          <td ><table width="100%"  cellspacing="0" cellpadding="6">
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="calendertext2"><span style="color:red">12</span><br>尼加拉瓜V.S波多黎各<br>00:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:9</span><br>
                                        多明尼加v.s委內瑞拉<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:5</span><br>
                                    </td>
                                </tr>
                                <!--13~19-->
                                <tr>
                                    <td class="calendertext" >13<br>尼加拉瓜v.s以色列<br>00:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:3</span><br>
                                        委內瑞拉v.s波多黎各<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:9:6</span><br>
                                    </td>
                                    <td class="calendertext" >14<br>多明尼加v.s尼加拉瓜<br>00:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:6:1</span><br>
                                        以色列v.s波多黎各<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:0:10</span><br>
                                    </td>
                                    <td class="calendertext" >15<br>尼加拉瓜v.s委內瑞拉<br>00:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:4</span><br>
                                        以色列v.s多明尼加<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:0:10</span><br>
                                    </td>
                                    <td class="calendertext" >16<br>委內瑞拉v.s以色列<br>00:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:5:1</span><br>
                                        波多黎各v.s多明尼加<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:5:2</span><br>
                                    </td>
                                    <td class="calendertext" >17<br></td>
                                    <td class="calendertext" ><span style="color:red">18</span><br><span style="background:#B87070;padding:3px;">八強賽</span><br>波多黎各v.s墨西哥<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:4:5</span><br>
                                    </td>
                                    <td class="calendertext2"><span style="color:red">19</span><br><span style="background:#B87070;padding:3px;">八強賽</span><br>美國v.s委內瑞拉<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:9:7</span><br>
                                    </td>
                                </tr>
                                <!--20~26-->
                                <tr>
                                    <td class="calendertext">20<br><span style="background:#6FB7B7;padding:3px;">四強賽</span><br>古巴v.s美國<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:2:14</span><br>
                                    </td>
                                    <td class="calendertext">21<br><span style="background:#6FB7B7;padding:3px;">四強賽</span><br>墨西哥v.s日本<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:5:6</span><br>
                                    </td>
                                    <td class="calendertext">22<br><span style="background:#FF8F59;padding:3px;">冠軍賽</span><br>美國v.s日本<br>07:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:2:3</span><br></td>
