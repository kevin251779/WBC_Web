        ...
        <td width="89" height="50" valign="middle" >
            <div style="margin-top:3%;text-align:right;margin-right:6%">
                  <select onchange="window.location.href=this.value;" style="font-size:1.2em;">
                    <option selected value="competitiondateA.php" href="competitiondateA.php">A組 台中洲際</option>
                          ...
                          <td ><table width="100%"  cellspacing="0" cellpadding="6">
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="calendertext" >8<br>古巴v.s荷蘭<br>12:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:2:4</span><br>
                                        巴拿馬v.s台灣<br>19:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:12:5</span><br>
                                    </td>
                                    <td class="calendertext">9<br>巴拿馬v.s荷蘭<br>12:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:3</span><br>
                                        義大利v.s古巴<br>19:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:6:3</span><br>
                                    </td>
                                    <td class="calendertext" >10<br>古巴v.s巴拿馬<br>12:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:13:4</span><br>
                                        義大利v.s台灣<br>19:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:7:11</span><br>
                                    </td>
                                    <td class="calendertext"><span style="color:red">11</span><br>巴拿馬v.s義大利<br>12:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:2:0</span><br>
                                        荷蘭v.s台灣<br>19:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:5:9</span><br>
                                    </td>
                                    <td class="calendertext2"><span style="color:red">12</span><br>
                                        台灣v.s古巴<br>12:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:7</span><br>
                                        荷蘭v.s義大利<br>19:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:7</span><br>
                                ...
                                <!--13~19-->
                                <tr>
                                    <td class="calendertext" >13<br></td>
                                    <td class="calendertext" >14<br></td>
                                    <td class="calendertext" >15<br></td>
                                    <td class="calendertext" >16<br></td>
