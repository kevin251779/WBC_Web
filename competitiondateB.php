        ...
        <td width="89" height="50" valign="middle" >
            <div style="margin-top:3%;text-align:right;margin-right:6%">
                  <select onchange="window.location.href=this.value;" style="font-size:1.2em;">
                    ...
                    <option selected  value="competitiondateB.php"href="competitiondateB.php">B組 東京巨蛋</option>
                          ...
                          <td ><table width="100%"  cellspacing="0" cellpadding="6">
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="calendertext">9<br>澳洲v.s韓國<br>11:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:8:7</span><br>
                                        中國v.s日本<br>18:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:1:8</span><br>
                                    </td>
                                    <td class="calendertext">10<br>捷克v.s中國<br>11:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:8:5</span><br>
                                        韓國v.s日本<br>18:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:4:13</span><br>
                                    </td>
                                    <td class="calendertext"><span style="color:red">11</span><br>中國v.s澳洲<br>11:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:2:12</span><br>
                                        捷克v.s日本<br>18:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:2:10</span><br>
                                    </td>
                                    <td class="calendertext2"><span style="color:red">12</span><br>
                                        捷克v.s韓國<br>11:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:3:7</span><br>
                                        日本v.s澳洲<br>18:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:7:1</span><br>

                                    </td>
                                </tr>
                                <!--13~19-->
                                <tr>
                                    <td class="calendertext" >13<br>澳洲v.s捷克<br>11:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:8:3</span><br>
                                        韓國v.s中國<br>18:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:22:2</span><br>
                                    </td>
                                    <td class="calendertext" >14<br></td>
                                    <td class="calendertext" >15<br><span style="background:#B87070;padding:3px;">八強賽</span><br>澳洲v.s古巴<br>18:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:3:4</span><br>
                                    </td>
                                    <td class="calendertext" >16<br><span style="background:#B87070;padding:3px;">八強賽</span><br>義大利v.s日本<br>18:00<br>
                                        <span style="background:#FFFFB9;padding:3px;">FINAL:3:9</span><br></td>
